#!/bin/bash
# EditInsta v1.0
# Coded by: thelinuxchoice (@linux_choice)
# Github: www.github.com/thelinuxchoice/editinsta
...
printf "\n" 
printf "\e[1;77m  _____    _ _ _   ___           _         \n"
printf " | ____|__| (_) |_|_ _|_ __  ___| |_ __ _  \n"
printf " |  _| / _\` | | __|| || '_ \/ __| __/ _\` | \n"
printf " | |__| (_| | | |_ | || | | \__ \ || (_| | \n"
printf " |_____\__,_|_|\__|___|_| |_|___/\__\__,_| v1.0\e[0m\n"
printf "\n" 
printf "\e[1;92m https://github.com/thelinuxchoice/editinsta\e[0m\n" 
printf "\n"                                           
}
...
printf "\n\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Chaging Password...\e[0m\n"
